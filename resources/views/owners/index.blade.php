                            ...
                            <tbody>
                                @forelse ($owners as $owner)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="gap-2">
                                                <a href="{{ route('owners.show', $owner) }}" class="btn btn-sm btn-info text-white">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center">No se encontraron dueños de vehículos.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
